...
export function inputHintBox(mode: string): string {
  return [
    ...
    '',
    `${NEOFETCH_ACCENT}beginner${RESET} /start · /next · /idea · /lab · /skills · /find · /download <SYMBOL> · /research <SYMBOL>`,
    `${NEOFETCH_ACCENT}flow${RESET}     /idea new "NVDA momentum" → /idea add-symbol latest NVDA → /lab workflow latest`,
    `${NEOFETCH_ACCENT}advanced${RESET} /tools · /agent "NVDA momentum" · /discover · /data info · /stats <SYMBOL>`,
    `${NEOFETCH_ACCENT}tools${RESET}    /skills · /tools · /agent · $tossquant-idea-coach · /hud · /ask <question> · /codex · /quant · /exit`,
