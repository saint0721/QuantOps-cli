...
export function codexRuntimeGuide(): JsonObject {
  return {
    ...
    primary_user: 'Codex-style coding or research agent',
    ...
    principles: [
      ...
      'Do not use QuantOps as a standalone chat agent or local TUI-first app.',
    ...
    workflow: [
      ...
      'session: persist handoff material for later Codex turns',
    ],
    minimal_commands: [
    ...
    removed_or_deemphasized: [
      'QuantOps-local chat/TUI as primary UX',
      'local agent command loops',
      'calling Codex from inside QuantOps by default',
